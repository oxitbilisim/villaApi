        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SiraNo = table.Column<int>(type: "integer", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VillaImageDetay", x => x.Id);
                    table.ForeignKey(
                        name: "FK_VillaImageDetay_Villa_VillaId",
                        column: x => x.VillaId,
                        principalTable: "Villa",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                table: "Il",
                columns: new[] { "Id", "Active", "Ad", "CreateDate", "EditDate", "IsDeleted", "Kod", "Sira" },
                values: new object[,]
                {
                    { 1, true, "Antalya", null, null, false, null, 0 },
                    { 2, true, "Muğla", null, null, false, null, 0 },
                    { 3, true, "Aydın", null, null, false, null, 0 },
                    { 4, true, "Ankara", null, null, false, null, 0 }
                });
            ...
            migrationBuilder.InsertData(
                table: "Mulk",
                columns: new[] { "Id", "Active", "Ad", "CreateDate", "EditDate", "IsDeleted" },
                values: new object[,]
                {
                    { 1, true, "Villa", null, null, false },
                    { 2, true, "Apart", null, null, false },
                    { 3, true, "Ev", null, null, false },
                    { 4, true, "Bungalov", null, null, false }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, true, "TL", null, null, false },
                    { 2, true, "USD", null, null, false },
                    { 3, true, "EURO", null, null, false },
                    { 4, true, "GBP", null, null, false }
                });
            ...
            migrationBuilder.InsertData(
                table: "Ilce",
                columns: new[] { "Id", "Active", "Ad", "CreateDate", "EditDate", "IlId", "IsDeleted" },
                values: new object[,]
                {
                    { 1, true, "Kaş", null, null, 1, false },
                    { 2, true, "Alanya", null, null, 1, false },
                    { 3, true, "Manavgat", null, null, 1, false },
                    { 4, true, "Kemer", null, null, 1, false },
                    { 5, true, "Konyaaltı", null, null, 1, false },
                    { 6, true, "Bodrum", null, null, 2, false },
                    { 7, true, "Fethiye", null, null, 2, false },
                    { 8, true, "Msrmaris", null, null, 2, false }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VillaImageDetay_VillaId",
