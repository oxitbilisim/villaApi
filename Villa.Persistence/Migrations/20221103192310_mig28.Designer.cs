...
namespace Villa.Persistence.Migrations
{
    ...
    [Migration("20221103192310_mig28")]
    partial class mig28
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "6d5b6957-d789-4861-84e0-0f199cf6a0a3",
                            ConcurrencyStamp = "3494297e-3132-4c8d-976e-7dcf8e19d0cb",
                            Name = "sistemadmin",
                            NormalizedName = "SISTEMADMIN"
                        },
                        new
                        {
                            Id = "ba4ddd03-841c-43d2-9cde-cb8c7cd1c8f9",
                            ConcurrencyStamp = "c2ed17b2-0b59-41ec-b700-3a5b702b58c3",
                            Name = "admin",
            ...
            modelBuilder.Entity("Villa.Domain.Auth.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "ba3e03c9-922a-4a0c-9a73-85c75f9dfdf2",
                            AccessFailedCount = 0,
                            Ad = "Mehmet",
                            ConcurrencyStamp = "75002996-0320-43ab-b20c-ce8279e88827",
                            ...
                            SecurityStamp = "b9aecf6a-9b79-4b4d-8a78-0b3f1f0c4616",
                            Soyad = "YILMAZ",
                        ...
                        new
                        {
                            Id = "63f09e18-db73-4884-bc2b-a9c865827e7d",
                            AccessFailedCount = 0,
                            Ad = "Ali",
                            ConcurrencyStamp = "b85d8ba3-8c5d-43cb-b185-e1fbb57cfba1",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEBLjouNqaeiVWbN0TbXUS3+ChW3d7aQIk/BQEkWBxlrdRRngp14b0BIH0Rp65qD6mA==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "b1ce7fd4-1b1e-4ee0-bc9b-f95da51e11d0",
                            Soyad = "DERİN",
                            TwoFactorEnabled = false,
                            UserName = "iladmin"
                        });
            ...
            modelBuilder.Entity("Villa.Domain.Entities.Collections", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Villa.Domain.Entities.CollectionVillas", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Villa.Domain.Entities.Parameters", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Villa.Domain.Entities.RezervasyonMaliBilgi", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("EvSahibineOdemeTarihi")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.Property<DateTimeOffset?>("TahsilatTarihi")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("Villa.Domain.Entities.Sayfa", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Villa.Domain.Entities.SayfaIcerik", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.ToTable("SayfaIcerik");
                });

            modelBuilder.Entity("Villa.Domain.Entities.SayfaSeo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Villa.Domain.Entities.VillaImageDetay", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Villa.Domain.Entities.VillaLokasyon", b =>
                {
                    ...
                    b.Property<string>("MarktUzaklik")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Villa.Domain.Entities.CollectionVillas", b =>
                {
                    b.HasOne("Villa.Domain.Entities.Collections", "Collections")
                        .WithMany()
            ...
            modelBuilder.Entity("Villa.Domain.Entities.Kategori", b =>
                {
                    b.HasOne("Villa.Domain.Entities.Kategori", null)
                        .WithMany("items")
            ...
            modelBuilder.Entity("Villa.Domain.Entities.PeriyodikFiyatAyarlari", b =>
                {
                    b.HasOne("Villa.Domain.Entities.ParaBirimi", null)
            ...
            modelBuilder.Entity("Villa.Domain.Entities.SayfaIcerik", b =>
                {
                    b.HasOne("Villa.Domain.Entities.Sayfa", "Sayfa")
                        .WithMany("SayfaIcerik")
            ...
            modelBuilder.Entity("Villa.Domain.Entities.Rezervasyon", b =>
                {
                    b.Navigation("RezervasyonMaliBilgi");
                });

            modelBuilder.Entity("Villa.Domain.Entities.Sayfa", b =>
                {
                    b.Navigation("SayfaIcerik");

                    b.Navigation("SayfaSeo");
                });
